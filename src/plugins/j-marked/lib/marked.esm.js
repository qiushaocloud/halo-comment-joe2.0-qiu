...
var Renderer_1 = class Renderer {
  ...
  bilibiliEmoji(text) {
    const href = cleanUrl$1(this.options.sanitize, this.options.bilibiliEmojiUrl, text + '.png');
  ...
  codeEmoji(text) {
    ...
    const href = cleanUrl$1(this.options.sanitize, this.options[`${extension === '.gif' ? 'tieba' : 'haha'}EmojiUrl`], `icon_${name}${extension}`);
