const DEFAULT_ASSETS_ADDR = !(process && process.env && process.env.NODE_ENV === 'production') ? '' : 'https://githubcdn.qiushaocloud.top/gh/qiushaocloud/halo-comment-joe2.0-qiu@master';
...
export default {
  ...
  assetsAddr: DEFAULT_ASSETS_ADDR, // 评论组件所需的 assets 资源地址，没有配置则采用默认为: https://githubcdn.qiushaocloud.top/gh/qiushaocloud/halo-comment-joe2.0-qiu@master
